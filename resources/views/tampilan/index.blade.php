                        ...
                        <div class="col-md-3">
                            <div class="card bg-primary text-white">
                                <div class="card-body">
                                    ...
                                    <a href="{{route('siswa.view')}}" class="btn btn-light">Lihat →</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-secondary text-white">
                                <div class="card-body">
                                    ...
                                    <a href="{{route('admin.view')}}" class="btn btn-light">Lihat →</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-success text-white">
                                <div class="card-body">
                                    ...
                                    <a href="{{route('kepsek.view')}}" class="btn btn-light">Lihat →</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-danger text-white">
                                <div class="card-body">
                                    ...
                                    <a href="{{route('kurikulum.view')}}" class="btn btn-light">Lihat →</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-warning text-white">
                                <div class="card-body">
                                    ...
                                    <a href="{{route('bk.view')}}" class="btn btn-light">Lihat →</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-info text-white">
                                <div class="card-body">
                                    ...
                                    <a href="{{route('wakel.view')}}" class="btn btn-light">Lihat →</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-secondary text-white">
                                <div class="card-body">
                                    ...
                                    <a href="{{route('guru.view')}}" class="btn btn-light">Lihat →</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-primary text-white">
                                <div class="card-body">
                                    ...
                                    <a href="{{route('kelas.view')}}" class="btn btn-light">Lihat →</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-success text-white">
                                <div class="card-body">
                                    ...
                                    <a href="{{route('mapel.view')}}" class="btn btn-light">Lihat →</a>
                                </div>
                            </div>
                        </div>
                        @endif

                        @if(auth('kepsek')->check() || auth('bk')->check() || auth('wakel')->check() ||
                        auth('guru')->check())
                        <div class="col-md-3">
                            <div class="card bg-primary text-white">
                                <div class="card-body">
