...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="#">Tambah Data BK</a></li>
        </ol>
    </nav>
</div><!-- End Page Title -->
...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('bk.store')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <img id="previewFoto_bk" src="#" alt="Preview Foto" style="max-width: 200px;">
                    </div>
                </div>
