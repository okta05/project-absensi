        ...
        <div class="card-body">
            ...
            <form method="post" action="{{route('kepsek.update', $editDataKepsek->id)}}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="textNama" id="textNama" value="{{$editDataKepsek->nama}}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="textNIP" id="textNIP" value="{{$editDataKepsek->nip}}"
                    ...
                    <div class="col-sm-10">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="text_jns_kelamin" value="Laki-laki"
                                id="text_jns_kelamin1" @if($editDataKepsek->jns_kelamin == 'Laki-laki') checked @endif>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="text_jns_kelamin" value="Perempuan"
                                id="text_jns_kelamin2" @if($editDataKepsek->jns_kelamin == 'Perempuan') checked @endif>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="textAlamat" value="{{$editDataKepsek->alamat}}" id=" textAlamat"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="number" name="text_no_telp" id="text_no_telp"
                            value="{{$editDataKepsek->no_telp}}" class=" form-control"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <img id="previewFoto_kepsek" src="{{ asset('storage/' . $editDataKepsek->foto_kepsek) }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="email" name="email" value="{{$editDataKepsek->email}}"  id="email" class="form-control"
